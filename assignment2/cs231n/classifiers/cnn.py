...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        H1 = int(1 + (H - filter_size + 2*pad) / stride)
        W1 = int(1 + (H - filter_size + 2*pad) / stride)
        ...
        self.params['W2'] = weight_scale * np.random.rand(num_filters * H2 * W2, hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        dX_conv_relu_p, dW1, db1 = conv_relu_pool_backward(dX_affine_r, cache_conv_relu_p)
